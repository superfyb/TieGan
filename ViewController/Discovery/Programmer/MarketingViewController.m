...
- (NSArray *)imageArray{
    if (!_imageArray) {
        _imageArray = [NSArray arrayWithObjects:@"轮播图-8",@"轮播图-1",@"轮播图-6",@"轮播图-7",@"轮播图-9",@"轮播图-10",@"轮播图-2",@"轮播图-3",@"轮播图-4",@"轮播图-5",@"轮播图-11",@"轮播图-12",@"轮播图-13", nil];
    }
    return _imageArray;
}
...
- (void)loadData{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://120.26.55.28:5053/v1/req/index/9?start=%@",self.lastData_id];
